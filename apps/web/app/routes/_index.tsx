  ...
  return (
    <div className="">
      ...
      <FeaturesListHomepage
        ...
        heading={{
          subtitle: "Our platform offers competitive challenge modes, precision scoring, live tournaments, and leaderboard rankings—designed to help CAD designers improve skills, compete, and track progress in a dynamic environment.",
          tag: "Competitive",
